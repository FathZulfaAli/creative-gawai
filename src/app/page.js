        ...
        <Container m={"10px"} ml={"2%"} maxW={"50rem"}>
          ...
          <Flex gap={"30px"}>
            <Box>
              ...
              <Image
                alt={"Kominfo dan bappebti"}
                src="https://www.heygotrade.com/4493c5d10ef4c9d133636077b7e0c529.svg"
                mt={"20px"}
                mb={"20px"}
              />
            ...
            <Box>
              ...
              <Image
                alt={"Kompas"}
                src="https://www.heygotrade.com/37c7ab093a3ba9133ef06230c16f6ff1.svg"
                mt={"40px"}
                mb={"35px"}
              />
              <Link
                target="_blank"
                href={
                  "https://www.kompas.id/baca/adv_post/gotrade-kini-legal-di-indonesia-trading-app-pertama-untuk-akses-pasar-saham-as"
                }
              >
                <Text color={"#33D49D"}>
                  Pelajari lebih lanjut <Icon as="ChevronRightIcon" />
